...
1. Run
    ```shell
    composer create-project --prefer-source --no-install --remove-vcs setono/sylius-video-plugin:1.14.x-dev ProjectName
    ``` 
...
[ico-code-coverage]: https://codecov.io/gh/Setono/SyliusVideoPlugin/branch/1.12.x/graph/badge.svg
...
[link-infection]: https://dashboard.stryker-mutator.io/reports/github.com/Setono/SyliusVideoPlugin/1.12.x
