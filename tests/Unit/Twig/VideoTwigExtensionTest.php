...
final class VideoTwigExtensionTest extends TestCase
{
     ...
     * @test
     */
    public function it_registers_the_render_poster_ready_and_media_url_functions(): void
    {
        ...
        self::assertSame(['setono_sylius_video_render', 'setono_sylius_video_poster', 'setono_sylius_video_ready', 'setono_sylius_video_media_url'], $names);
    }
